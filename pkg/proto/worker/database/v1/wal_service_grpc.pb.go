...
const (
	WALService_ListWALEntries_FullMethodName = "/worker.database.v1.WALService/ListWALEntries"
	WALService_TruncateWAL_FullMethodName    = "/worker.database.v1.WALService/TruncateWAL"
)
...
var WALService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "worker.database.v1.WALService",
	...
	Metadata: "worker/database/v1/wal_service.proto",
}
