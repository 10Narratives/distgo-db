...
const (
	DatabaseService_ListDatabases_FullMethodName  = "/worker.database.v1.DatabaseService/ListDatabases"
	DatabaseService_GetDatabase_FullMethodName    = "/worker.database.v1.DatabaseService/GetDatabase"
	DatabaseService_CreateDatabase_FullMethodName = "/worker.database.v1.DatabaseService/CreateDatabase"
	DatabaseService_UpdateDatabase_FullMethodName = "/worker.database.v1.DatabaseService/UpdateDatabase"
	DatabaseService_DeleteDatabase_FullMethodName = "/worker.database.v1.DatabaseService/DeleteDatabase"
)
